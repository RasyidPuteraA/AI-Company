# INTERNAL-038: Add Minimal Chat Command Bar UI
...
Goal:
Redesign dashboard interaction around a single ChatGPT-style command bar with plus menu and slash commands for owner commands, uploads, conversion, workflow actions, and owner decisions.
...
- Update AGENT_HANDOVER.md with INTERNAL-038 notes.
