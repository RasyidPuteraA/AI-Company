...
- company/learning/lessons/LESSON-20260614121748-c5d3e6fe71.md: A shared-resource lock constrained or blocked work. (status=proposed)
...
- company/learning/patterns/PATTERN-dashboard-health.md: Dashboard health regressions (count=4)

## Agent-Specific Notes

- owner: failed/error events=0, blocked tasks=0, stale in-progress tasks=0
- pm_agent: failed/error events=1, blocked tasks=0, stale in-progress tasks=0
